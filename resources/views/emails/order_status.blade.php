<html>
    <body>
        <table style="width: 700px;">
           ...
           <tr><td>&nbsp;</td></tr>
           <tr><td>Your order #{{ $order_id }} has been updated to {{ $order_status }}. Your Order details are as below :-</td></tr>
           
           @if(!empty($courier_name) && !empty($tracking_number))
            <tr><td>&nbsp;</td></tr>
            <tr>
              <td>
              Courier Partner name is {{ $courier_name }} <br> Tracking Number is {{ $tracking_number }}
              </td>
            </tr>
           @endif
