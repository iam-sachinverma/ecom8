<?php use App\Models\Product; ?>
                ...
                <article class="item-cart">
                   <figure class="itemside mb-3">
                        <a href="{{ url('product/'.$item['product']['id']) }}">
                           <div class="aside">
                               <img src="{{ asset('images/product_images/small/'.$item['product']['main_image']) }}" class="rounded border img-md">
                            </div>
                        </a>
    ...
    <section class="padding-around" id="price_details" style="font-size: 13px;">
        ...
        <dl class="dlist-align">
            ...
            <dd class="text-end">
                &#8377<strong class="grand_total"> {{ $total_price - Session::get('couponAmount') }}</strong>
            </dd>
