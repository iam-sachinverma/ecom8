    ...
    <div class="container">
      <div class="row pb-3">
        <div class="col-md-3 col-sm-6 mb-4">
          <div class="d-flex"><i class="bi bi-truck text-primary" style="font-size: 1.9rem;"></i>
            <div class="ps-3">
        ...
        <div class="col-md-3 col-sm-6 mb-4">
          <div class="d-flex"><i class="bi bi-credit-card text-primary" style="font-size: 1.9rem;"></i>
            <div class="ps-3">
        ...
        <div class="col-md-3 col-sm-6 mb-4">
          <div class="d-flex"><i class="bi bi-telephone-forward text-primary" style="font-size: 1.9rem;"></i>
            <div class="ps-3">
        ...
        <div class="col-md-3 col-sm-6 mb-4">
          <div class="d-flex"><i class="bi bi-shield-check text-primary" style="font-size: 1.9rem;"></i>
            <div class="ps-3">
        ...
        <div class="col-md-6 text-center text-md-start mb-4">
          <div class="text-nowrap mb-4">
            <a class="d-inline-block align-middle mt-n1 me-3" href="#">
              <!-- <img class="d-block" src="img/footer-logo-light.png" width="117" alt="PantryShop"> -->
      ...
      <div class="pb-4 fs-xs text-light opacity-50 text-center text-md-start">© All rights reserved. Made by <a class="text-light" href="#" target="_blank" rel="noopener">Soul</a></div>
    </div>
  </div>
</footer>
