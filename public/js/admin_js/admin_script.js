$(document).ready(function(){
    ...
    // CMS Page Active and Inactive Status
    $(document).on("click",".updateCmsPageStatus",function(){      
        ...
        $.ajax({
            ...
            success:function(resp){
                if(resp['status']==0){
                    $("#page-"+page_id).html("<i class='fas fa-toggle-off fa-lg' aria-hidden='true' status='Inactive'></i>");
                }else if(resp['status']==1){
                    $("#page-"+page_id).html("<i class='fas fa-toggle-on fa-lg' aria-hidden='true' status='Active'></i>");
                }
    ...
    // Ratings & Reviews Active and Inactive Status
    $(document).on("click",".updateRatingStatus",function(){      
        ...
        $.ajax({
            ...
            success:function(resp){
                if(resp['status']==0){
                    $("#rating-"+rating_id).html("<i class='fas fa-toggle-off fa-lg' aria-hidden='true' status='Inactive'></i>");
                }else if(resp['status']==1){
                    $("#rating-"+rating_id).html("<i class='fas fa-toggle-on fa-lg' aria-hidden='true' status='Active'></i>");
                }
